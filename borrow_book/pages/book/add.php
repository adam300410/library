...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        $stmt = $pdo->prepare("INSERT INTO book_info2 (isbn, dsedj_no, cal_no, title, author, publisher, published_date, image_url) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    <div class="container mt-4">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" id="cal_no" name="cal_no" required>
            </div>
